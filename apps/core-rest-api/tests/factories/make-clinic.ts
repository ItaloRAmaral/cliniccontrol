...
import { CreateClinicInputDto } from '../../src/app/core/domains/clinic/use-cases/create-clinic/create-clinic-dto';
...
export function makeClinic(
  ...
  override: Partial<CreateClinicInputDto> = {},
): ClinicEntity {
...
export class ClinicFactory {
  ...
  async makePrismaClinic(
    clinic: Partial<CreateClinicInputDto> = {},
